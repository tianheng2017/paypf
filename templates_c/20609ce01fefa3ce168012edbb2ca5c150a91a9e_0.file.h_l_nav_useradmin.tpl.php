...
/* Smarty version 3.1.30, created on 2020-04-05 15:29:25
  from "E:\pay.pf.Currencyfusion.top\pay\app\views\v1\admin\h_l_nav_useradmin.tpl" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.30',
  'unifunc' => 'content_5e8988d5970317_05135859',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '20609ce01fefa3ce168012edbb2ca5c150a91a9e' => 
    array (
      0 => 'E:\\pay.pf.Currencyfusion.top\\pay\\app\\views\\v1\\admin\\h_l_nav_useradmin.tpl',
      1 => 1565769678,
      2 => 'file',
    ),
  ),
...
function content_5e8988d5970317_05135859 (Smarty_Internal_Template $_smarty_tpl) {
?>
    <style>
	td, th {
		padding: 6px 2px;
...
/index.php/admin/myinfo_useradmin" class="waves-effect waves-cyan"><i class="mdi-action-dns"></i> 系统配置</a>
                    </li>
...
/index.php/admin/adminsetlog/page/1">操作日志</a>
                                        </li>
                                    </ul>
                                </div>
                            </li>
					...
					<li class="bold"><a href="/<?php echo INSTALL_DIR;?>
/index.php/admin/user/page/1" class="waves-effect waves-cyan"><i class="mdi-social-people-outline"></i> 用户管理</a>
                    </li>
					
					
					
					<li class="bold"><a href="/<?php echo INSTALL_DIR;?>
/index.php/admin/moneyadd" class="waves-effect waves-cyan"><i class="mdi-action-wallet-membership"></i> RMB充值</a>
                    </li>
                        ...
                        <ul class="collapsible collapsible-accordion">
                            <li class="bold"><a class="collapsible-header  waves-effect waves-cyan active2 active"><i class="mdi-action-view-carousel"></i> 提现管理</a>
                                <div class="collapsible-body">
                                    <ul>
										<li><a href="/<?php echo INSTALL_DIR;?>
/index.php/admin/cashing/page/1">审核中</a>
                                        </li>
                                        <li><a href="/<?php echo INSTALL_DIR;?>
/index.php/admin/cashed/page/1">已处理</a>
                                        </li>
                        ...
                        <ul class="collapsible collapsible-accordion">
                            <li class="bold"><a class="collapsible-header  waves-effect waves-cyan active2 active"><i class="mdi-notification-vpn-lock"></i> 账单明细</a>
                                <div class="collapsible-body">
                                    <ul>
										<li><a href="/<?php echo INSTALL_DIR;?>
/index.php/admin/capitaldetails/page/1">资金明细</a>
                                        </li>
                                        <li><a href="/<?php echo INSTALL_DIR;?>
/index.php/admin/orderdetails/page/1">订单明细</a>
                                        </li>
										<li><a href="/<?php echo INSTALL_DIR;?>
/index.php/admin/orderdetails112_113/page/1">已支付订单</a>
                                        </li>
                                    </ul>
                                </div>
                            </li>
					...
					<li class="bold"><a target="_blank" href="/<?php echo INSTALL_DIR;?>
