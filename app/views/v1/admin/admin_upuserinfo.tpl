...
<body>
                        ...
                        <div class="row">
                            <div class="col s12">
                                <div class="card-panel">
                                    <h4 class="header2">用户编辑 - <{$datauser['username']}></h4>
                                    <div class="row">
                                        <form class="col s12" id="videoform">
                                            <div class="row">
                                                <div class="input-field col s6">
                                                    <input id="password" name="password" type="password" value="<{$datauser['password']}>">
                                                    <label for="first_name">密码</label>
                                                </div>
												
												<div class="input-field col s6">
                                                    <input id="note" name="note" type="text" value="<{$datauser['note']}>">
                                                    <label for="first_name">备注</label>
                                                </div>
												
												
                                                <div class="input-field col s6">
                                                    <input id="interestrate" name="interestrate" type="text" value="<{$datauser['interestrate']}>">
                                                    <label for="first_name">提现利率</label>
                                                </div>
												<div class="input-field col s6">
                                                    <input id="agencyinterestratem" name="agencyinterestratem" type="text" value="<{$datauser['agencyinterestratem']}>">
    ...
    <script>
        $(".btnvideoadd").click(function () {
            ...
            var options = {
                url: '/<{INSTALL_DIR}>/index.php/admin/upuserinfodo/id/<{$datauser["id"]}>',
                type: 'post',
                dataType: 'text',
