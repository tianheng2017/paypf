...
<body>
                            ...
                            <div class="col s12">
                                <table class="striped" style="border: 1px solid #bdbdbd;">
                                    ...
                                    <tr>
										...
										<th data-field="ulb">金额</th>
										
										<th data-field="">手续费</th>
										
										<th data-field="">需支付金额</th>
                                    ...
                                    <tr class="usertr<{$datai['id']}>">
										...
										<td class="tdtcenter"><{$datai['money']*$datai['interestrate']/100}></td>
                                        ...
                                        <td class="tdtcenter">
										<div onclick="sedokM('<{$datai['id']}>')" class="btn cyan">通过</div>
										<div onclick="sednoM('<{$datai['id']}>')" class="btn">驳回</div>
										
										<a href="/<{INSTALL_DIR}>/index.php/admin/user/username/<{$datai['username']}>" target="_blank" class="btn cyan">收款信息</a>
										</td>
    ...
    <script type="text/javascript">
        function sedokM(val) {
            ...
            var options = {
                url: '/<{INSTALL_DIR}>/index.php/admin/cashing_ed',
                type: 'post',
                dataType: 'text',
                data: 'id='+val,
		...
		function sednoM(val) {
            var trobj="usertr"+val;
            var options = {
                url: '/<{INSTALL_DIR}>/index.php/admin/cashing_errored',
                type: 'post',
                dataType: 'text',
                data: 'id='+val,
                success: function (data) {
