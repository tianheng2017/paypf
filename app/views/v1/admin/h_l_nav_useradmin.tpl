        ...
        <div class="wrapper">
            ...
            <aside id="left-sidebar-nav">
                <ul id="slide-out" class="side-nav fixed leftside-navigation">
					...
					<li class="bold"><a href="/<{INSTALL_DIR}>/index.php/admin/myinfo_useradmin" class="waves-effect waves-cyan"><i class="mdi-action-dns"></i> 系统配置</a>
                    </li>
					
					<li class="no-padding">
                        <ul class="collapsible collapsible-accordion">
                            <li class="bold"><a class="collapsible-header  waves-effect waves-cyan"><i class="mdi-action-verified-user"></i> 安全监控</a>
                                <div class="collapsible-body">
                                    <ul>
                                        <li><a href="/<{INSTALL_DIR}>/index.php/admin/adminsetlog/page/1">操作日志</a>
                                        </li>
                                    </ul>
                                </div>
                            </li>
					...
					<li class="bold"><a href="/<{INSTALL_DIR}>/index.php/admin/user/page/1" class="waves-effect waves-cyan"><i class="mdi-social-people-outline"></i> 用户管理</a>
                    </li>
					
					
					
					<li class="bold"><a href="/<{INSTALL_DIR}>/index.php/admin/moneyadd" class="waves-effect waves-cyan"><i class="mdi-action-wallet-membership"></i> RMB充值</a>
                    </li>
					...
					<li class="no-padding">
                        <ul class="collapsible collapsible-accordion">
                            <li class="bold"><a class="collapsible-header  waves-effect waves-cyan active2 active"><i class="mdi-action-view-carousel"></i> 提现管理</a>
                                <div class="collapsible-body">
                                    <ul>
										<li><a href="/<{INSTALL_DIR}>/index.php/admin/cashing/page/1">审核中</a>
                                        </li>
                                        <li><a href="/<{INSTALL_DIR}>/index.php/admin/cashed/page/1">已处理</a>
                                        </li>
					...
					<li class="no-padding">
                        <ul class="collapsible collapsible-accordion">
                            <li class="bold"><a class="collapsible-header  waves-effect waves-cyan active2 active"><i class="mdi-notification-vpn-lock"></i> 账单明细</a>
                                <div class="collapsible-body">
                                    <ul>
										<li><a href="/<{INSTALL_DIR}>/index.php/admin/capitaldetails/page/1">资金明细</a>
                                        </li>
                                        <li><a href="/<{INSTALL_DIR}>/index.php/admin/orderdetails/page/1">订单明细</a>
                                        </li>
										<li><a href="/<{INSTALL_DIR}>/index.php/admin/orderdetails112_113/page/1">已支付订单</a>
                                        </li>
                                    </ul>
                                </div>
                            </li>
					...
					<li class="bold"><a target="_blank" href="/<{INSTALL_DIR}>/index.php/index/sdkdoc" class="waves-effect waves-cyan"><i class="mdi-action-description"></i> 接入文档</a>
                    </li>
