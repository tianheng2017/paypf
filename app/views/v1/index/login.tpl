		...
		<div class="col-md-4">
			...
			<form action="/<{INSTALL_DIR}>/index.php/index/loginform" method="post" id="form_login" class="fh5co-form animate-box" data-animate-effect="fadeInLeft" style="box-shadow: 0 11px 15px 0px;">
				...
				<div class="form-group">
					...
					<a class="btn btn-primary" href="/<{INSTALL_DIR}>/index.php/index/reg" style="line-height:3em">去注册</a>
				</div>
			</form>
			<!-- END Sign In Form -->
...
$(document).ready(function () {
	$("#btn_login").click(function () {
		var options = {
			url: '/<{INSTALL_DIR}>/index.php/index/loginform',
			type: 'post',
			dataType: 'text',
					...
					if (data == '1001') {
						$.toast({
							...
							afterHidden: function () {
								self.location = '/<{INSTALL_DIR}>/index.php/console/home';
							}
						});
