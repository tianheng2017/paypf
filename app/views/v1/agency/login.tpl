...
<div class="container">
	...
	<div class="row">
		<div class="col-md-4">
			...
			<!-- Start Sign In Form -->
			<form action="/<{INSTALL_DIR}>/index.php/agency/loginform" method="post" id="form_login" class="fh5co-form animate-box" data-animate-effect="fadeInLeft" style="box-shadow: 0 11px 15px 0px;">
				<h2>代理登录/Log in</h2>
...
$(document).ready(function () {
	$("#btn_login").click(function () {
		var options = {
			url: '/<{INSTALL_DIR}>/index.php/agency/loginform',
			type: 'post',
			dataType: 'text',
					...
					if (data == '1001') {
						$.toast({
							...
							afterHidden: function () {
								self.location = '/<{INSTALL_DIR}>/index.php/agency/home';
							}
						});
