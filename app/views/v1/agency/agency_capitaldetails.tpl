                            ...
                            <div class="col s12 center-align pagecontenttitle">
                                <ul class="collection">
									...
									<div class="input-field col s10">
										<input class="selkeyword" id="selkeyword" name="selkeyword" value="<{$selusername}>" placeholder="请输入资金类型（代理抽成、提现、后台充值）" type="text">
                            ...
                            <div class="col s12">
                                <table class="striped">
                                    ...
                                    <tr class="usertr<{$datai['id']}>">
										...
										<{if $datai['type'] eq "211"}>
										代理抽成（OID:<{$datai['orderid']}>）
										<{/if}>
										</td>
