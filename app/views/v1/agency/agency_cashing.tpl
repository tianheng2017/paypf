...
<body>
                            ...
                            <div class="col s12 center-align pagecontenttitle">
                                <ul class="collection">
									...
									<div class="input-field col s10">
										<input class="selkeyword" id="selkeyword" name="selkeyword" value="<{$selusername}>" placeholder="请输入Id" type="text">
                            ...
                            <div class="col s12">
                                <table class="striped" style="border: 1px solid #bdbdbd;">
                                    ...
                                    <tr>
										...
										<th data-field="">提现金额</th>
										
										<th data-field="">费率</th>
										
										<th data-field="">结算金额</th>

										
										<th data-field="state">状态</th>
										
										<th data-field="time">提现时间</th>
                                    ...
                                    <tr class="usertr<{$datai['id']}>">
										...
										<td class="tdtcenter"><{$datai['money']-$datai['money']*$datai['interestrate']/100}></td>
										
										
										
										<td class="tdtcenter">
										<{if $datai['state'] eq "111"}>
										<div class="btn cyan" style="box-shadow:none;">审核中</div>
										<{/if}>
										<{if $datai['state'] eq "112"}>
										<div class="btn cyan" style="box-shadow:none;">提现成功</div>
										<{/if}>
										<{if $datai['state'] eq "113"}>
										<div class="btn" style="box-shadow:none;">提现失败</div>
										<{/if}>
										</td>
								...
								<div class="col s12 paginationdiv">
									<ul class="pagination">
										<{if $pallnum>10}>
										<li class="active" style="background-color: #607d8b;"><a href="/<{INSTALL_DIR}>/index.php/agency/<{$pagesign}>/page/1<{$pagehrefadd}>">1</a></li>
										<{/if}>
										
										<{if $page<=1}>
										<li class="disabled"><a href="#!"><i class="mdi-navigation-chevron-left"></i></a></li>
										<{else}>
										<li class="waves-effect"><a href="/<{INSTALL_DIR}>/index.php/agency/<{$pagesign}>/page/<{$page-1}><{$pagehrefadd}>"><i class="mdi-navigation-chevron-left"></i></a></li>
										<{/if}>
										<{for $fooi=$pallnums to $pallnume}>
										<li class="<{if $fooi==$page}>active<{else}>waves-effect<{/if}>"><a href="/<{INSTALL_DIR}>/index.php/agency/<{$pagesign}>/page/<{$fooi}><{$pagehrefadd}>"><{$fooi}></a></li>
										<{/for}>
										<{if $pallnum<=$page}>
										<li class="disabled"><a href="#!"><i class="mdi-navigation-chevron-right"></i></a></li>
										<{else}>
										<li class="waves-effect"><a href="/<{INSTALL_DIR}>/index.php/agency/<{$pagesign}>/page/<{$page+1}><{$pagehrefadd}>"><i class="mdi-navigation-chevron-right"></i></a></li>
										<{/if}>
										
										<{if $pallnum>10}>
										<li class="active" style="background-color: #607d8b;"><a href="/<{INSTALL_DIR}>/index.php/agency/<{$pagesign}>/page/<{$pallnum}><{$pagehrefadd}>"><{$pallnum}></a></li>
										<{/if}>
    ...
    <script type="text/javascript">
        ...
        $(".seabtna").click(function () {
            self.location = '/<{INSTALL_DIR}>/index.php/agency/<{$pagesign}>/username/'+$(".selkeyword").val();
        });
		
		$(".selpagebtn").click(function () {
            self.location = '/<{INSTALL_DIR}>/index.php/agency/<{$pagesign}>/page/'+$(".selpagev").val()+'<{$pagehrefadd}>';
        });
