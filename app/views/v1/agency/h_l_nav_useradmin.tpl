        ...
        <div class="wrapper">
            ...
            <aside id="left-sidebar-nav">
                <ul id="slide-out" class="side-nav fixed leftside-navigation">
					...
					<li class="bold"><a href="/<{INSTALL_DIR}>/index.php/agency/home" class="waves-effect waves-cyan"><i class="mdi-action-dns"></i> 个人中心</a>
                    </li>
					
					<li class="bold"><a href="/<{INSTALL_DIR}>/index.php/agency/user/page/1" class="waves-effect waves-cyan"><i class="mdi-social-people-outline"></i> 用户管理</a>
                    </li>
                        ...
                        <ul class="collapsible collapsible-accordion">
                            <li class="bold"><a class="collapsible-header  waves-effect waves-cyan active2 active"><i class="mdi-action-view-carousel"></i> 提现管理</a>
                                <div class="collapsible-body">
                                    <ul>
										<li><a href="/<{INSTALL_DIR}>/index.php/agency/cashsubmit">申请提现</a>
                                        </li>
										<li><a href="/<{INSTALL_DIR}>/index.php/agency/cashing/page/1">提现审核中</a>
                                        </li>
                                        <li><a href="/<{INSTALL_DIR}>/index.php/agency/cashed/page/1">提现已处理</a>
                                        </li>
					...
					<li class="no-padding">
                        <ul class="collapsible collapsible-accordion">
                            <li class="bold"><a class="collapsible-header  waves-effect waves-cyan active2 active"><i class="mdi-notification-vpn-lock"></i> 账单明细</a>
                                <div class="collapsible-body">
                                    <ul>
										<li><a href="/<{INSTALL_DIR}>/index.php/agency/capitaldetails/page/1">资金明细</a>
                                        </li>
                                        <li><a href="/<{INSTALL_DIR}>/index.php/agency/orderdetails/page/1">用户订单明细</a>
                                        </li>
										<li><a href="/<{INSTALL_DIR}>/index.php/agency/orderdetails112_113/page/1">用户已支付订单</a>
                                        </li>
                                    </ul>
                                </div>
                            </li>
