...
function(t) {
	...
	2: function(t, e) {
		var n = t.exports = function() {
				...
				function h(t) {
					var e, n;
					return L[t] || (e = O.createElement(t), O.body.appendChild(e), n = getComputedStyle(e, "").getPropertyValue("display"), e.parentNode.removeChild(e), "none" == n && (n = "block"), L[t] = n), L[t]
				}

				function p(t) {
					return "children" in t ? N.call(t.children) : T.map(t.childNodes, function(t) {
						if (1 == t.nodeType) return t
					})
				}

				function d(t, e, n) {
					for (E in e) n && (o(e[E]) || G(e[E])) ? (o(e[E]) && !o(t[E]) && (t[E] = {}), G(e[E]) && !G(t[E]) && (t[E] = []), d(t[E], e[E], n)) : e[E] !== b && (t[E] = e[E])
				}
				...
				return Y.matches = function(t, e) {
					...
					var r, i = t.parentNode,
						o = !i;
					return o && (i = W).appendChild(t), r = ~Y.qsa(i, e).indexOf(t), o && W.removeChild(t), r
				}, C = function(t) {
					...
					var r, i, a;
					return _.test(t) && (r = T(O.createElement(RegExp.$1))), r || (t.replace && (t = t.replace(q, "<$1></$2>")), e === b && (e = D.test(t) && RegExp.$1), e in H || (e = "*"), a = H[e], a.innerHTML = "" + t, r = T.each(N.call(a.childNodes), function() {
						a.removeChild(this)
					...
					var r;
					if (!t) return Y.Z();
					if ("string" == typeof t) if (t = t.trim(), "<" == t[0] && D.test(t)) r = Y.fragment(t, RegExp.$1, n), t = null;
					else {
						if (n !== b) return T(n).find(t);
						r = Y.qsa(O, t)
					} else {
				...
				function(t, e) {
					...
					ready: function(t) {
						return Z.test(O.readyState) && O.body ? t(T) : O.addEventListener("DOMContentLoaded", function() {
							t(T)
						}, !1), this
					},
					get: function(t) {
						return t === b ? N.call(this) : this[t >= 0 ? t : t + this.length]
					},
					toArray: function() {
						return this.get()
					},
					...
					not: function(t) {
						...
						if (e(t) && t.call !== b) this.each(function(e) {
							...
							var r = "string" == typeof t ? this.filter(t) : a(t) && e(t.item) ? N.call(t) : T(t);
					...
					offsetParent: function() {
						return this.map(function() {
							for (var t = this.offsetParent || O.body; t && !F.test(t.nodeName) && "static" == T(t).css("position");) t = t.offsetParent;
							return t
						})
					}
					...
					T.fn[t] = function(i) {
						...
						return i === b ? n(a) ? a["inner" + e] : r(a) ? a.documentElement["scroll" + e] : (o = this.offset()) && o[t] : this.each(function(e) {
							a = T(this), a.css(t, v(this, i, e, a[t]()))
						})
					}
				...
				}), Y.Z.prototype = T.fn, Y.uniq = k, Y.deserializeValue = x, T.zepto = Y, T
			}();
		!
		function(t) {
			function e(t) {
			...
			C.href = window.location.href, t.active = 0, t.ajaxJSONP = function(e, n) {
				...
				var g, x = i.accepts[p],
					...
					T = i.xhr(),
					k = T.setRequestHeader;
				if (c && c.promise(T), i.crossDomain || b("X-Requested-With", "XMLHttpRequest"), b("Accept", x || "*/*"), (x = i.mimeType || x) && (x.indexOf(",") > -1 && (x = x.split(",", 2)[0]), T.overrideMimeType && T.overrideMimeType(x)), (i.contentType || i.contentType !== !1 && i.data && "GET" != i.type.toUpperCase()) && b("Content-Type", i.contentType || "application/x-www-form-urlencoded"), i.headers) for (v in i.headers) b(v, i.headers[v]);
				if (T.setRequestHeader = b, T.onreadystatechange = function() {
					if (4 == T.readyState) {
						T.onreadystatechange = u, clearTimeout(g);
						var e, n = !1;
						if (T.status >= 200 && T.status < 300 || 304 == T.status || 0 == T.status && "file:" == E) {
							...
							try {
								"script" == p ? (0, eval)(e) : "xml" == p ? e = T.responseXML : "json" == p && (e = S.test(e) ? null : t.parseJSON(e))
							} catch (t) {
								n = t
							}
							n ? s(n, "parsererror", T, i, c) : a(e, T, i, c)
						} else s(T.statusText || null, T.status ? "error" : "abort", T, i, c)
					}
				}, o(T, i) === !1) return T.abort(), s(null, "abort", T, i, c), T;
				if (i.xhrFields) for (v in i.xhrFields) T[v] = i.xhrFields[v];
				var j = !("async" in i) || i.async;
				T.open(i.type, i.url, j, i.username, i.password);
				for (v in w) k.apply(T, w[v]);
				return i.timeout > 0 && (g = setTimeout(function() {
					T.onreadystatechange = u, T.abort(), s(null, "timeout", T, i, c)
	...
	3: function(t, e) {
		...
		var n = {
			query: function(t) {
				var e = location.search.slice(location.search.indexOf("?") + 1),
					n = e.split("&") || [],
					r = "";
				return n.forEach(function(e) {
					0 === e.indexOf(t + "=") && (r = e.slice(t.length + 1))
				}), r
			},
			isNull: function(t) {
			...
			go: function(t) {
				...
				e.setAttribute("href", t), document.querySelector("body").appendChild(e), n.initEvent("click", !1, !0), e.dispatchEvent(n), e.click(), e.parentNode.removeChild(e)
			}
		};
		e.
	default = n
	...
	12: function(t, e) {
		var n = t.exports = function() {
				...
				function f(t, e) {
					return "number" != typeof e || _[u(t)] ? e : e + "px"
				}

				function h(t) {
					var e, n;
					return A[t] || (e = M.createElement(t), M.body.appendChild(e), n = getComputedStyle(e, "").getPropertyValue("display"), e.parentNode.removeChild(e), "none" == n && (n = "block"), A[t] = n), A[t]
				}
				...
				return J.matches = function(t, e) {
					...
					var r, i, a;
					return F.test(t) && (r = S(M.createElement(RegExp.$1))), r || (t.replace && (t = t.replace($, "<$1></$2>")), e === E && (e = q.test(t) && RegExp.$1), e in X || (e = "*"), a = X[e], a.innerHTML = "" + t, r = S.each(L.call(a.childNodes), function() {
						a.removeChild(this)
					...
					var r;
					if (!t) return J.Z();
					if ("string" == typeof t) if (t = t.trim(), "<" == t[0] && q.test(t)) r = J.fragment(t, RegExp.$1, n), t = null;
					else {
						if (n !== E) return S(n).find(t);
						r = J.qsa(M, t)
					} else {
						if (e(t)) return S(M).ready(t);
						if (J.isZ(t)) return t;
						if (Q(t)) r = s(t);
						else if (i(t)) r = [t], t = null;
						else if (q.test(t)) r = J.fragment(t.trim(), RegExp.$1, n), t = null;
						else {
							if (n !== E) return S(n).find(t);
							r = J.qsa(M, t)
						}
				...
				function(t, e) {
					...
					concat: function() {
						...
						return P.apply(J.isZ(this) ? this.toArray() : this, n)
					},
					map: function(t) {
					...
					ready: function(t) {
						return U.test(M.readyState) && M.body ? t(S) : M.addEventListener("DOMContentLoaded", function() {
							t(S)
						}, !1), this
					},
					get: function(t) {
					...
					not: function(t) {
						...
						if (e(t) && t.call !== E) this.each(function(e) {
							...
							var r = "string" == typeof t ? this.filter(t) : a(t) && e(t.item) ? L.call(t) : S(t);
							this.forEach(function(t) {
								r.indexOf(t) < 0 && n.push(t)
							})
						}
					...
					css: function(e, n) {
						if (arguments.length < 2) {
							...
							if ("string" == typeof e) {
								if (!r) return;
								return r.style[k(e)] || getComputedStyle(r, "").getPropertyValue(e)
							}
							if (Q(e)) {
								if (!r) return;
								var i = {},
								...
								return S.each(e, function(t, e) {
									i[e] = r.style[k(e)] || o.getPropertyValue(e)
								}), i
							}
						}
						var a = "";
					...
					offsetParent: function() {
						return this.map(function() {
							for (var t = this.offsetParent || M.body; t && !R.test(t.nodeName) && "static" == S(t).css("position");) t = t.offsetParent;
							return t
						})
					}
					...
					S.fn[e] = function() {
						var e, i, o = S.map(arguments, function(n) {
							...
							return e = t(n), "array" == e ? (n.forEach(function(t) {
								return t.nodeType !== E ? r.push(t) : S.zepto.isZ(t) ? r = r.concat(t.get()) : void(r = r.concat(J.fragment(t)))
							}), r) : "object" == e || null == n ? n : J.fragment(n)
						}),
							a = this.length > 1;
						return o.length < 1 ? this : this.each(function(t, e) {
							i = r ? e : e.parentNode, e = 0 == n ? e.nextSibling : 1 == n ? e.firstChild : 2 == n ? e : null;
							var s = S.contains(M.documentElement, i);
							o.forEach(function(t) {
								if (a) t = t.cloneNode(!0);
		...
		function(t) {
			...
			function u(e, n) {
				if (n || !e.isDefaultPrevented) {
					...
					} catch (t) {}(n.defaultPrevented !== f ? n.defaultPrevented : "returnValue" in n ? n.returnValue === !1 : n.getPreventDefault && n.getPreventDefault()) && (e.isDefaultPrevented = b)
				}
				return e
			}
			...
			function f(t) {
				return t && (t = t.split(";", 2)[0]), t && (t == S ? "html" : t == T ? "json" : b.test(t) ? "script" : E.test(t) && "xml") || "text"
			}
			...
			function m(e, n, r, i) {
				var o, a = t.isArray(n),
					s = t.isPlainObject(n);
				t.each(n, function(n, c) {
					o = t.type(c), i && (n = r ? i : i + "[" + (s || "object" == o || "array" == o ? n : "") + "]"), !i && a ? e.add(c.name, c.value) : "array" == o || !r && "object" == o ? m(e, c, r, n) : e.add(n, c)
				})
			}
			var v, g, y = +new Date,
				x = window.document,
			...
			k.href = window.location.href, t.active = 0, t.ajaxJSONP = function(e, n) {
				...
				return n && n.promise(p), t(l).on("load error", function(o, c) {
					...
					r = arguments
				}, l.src = e.url.replace(/\?(.+)=\?/, "?$1=" + u), x.head.appendChild(l), e.timeout > 0 && (i = setTimeout(function() {
					h("timeout")
				}, e.timeout)), p)
			}, t.ajaxSettings = {
				type: "GET",
				...
				var n, i, c = t.extend({}, e || {}),
					d = t.Deferred && t.Deferred();
				for (v in t.ajaxSettings) void 0 === c[v] && (c[v] = t.ajaxSettings[v]);
				r(c), c.crossDomain || (n = x.createElement("a"), n.href = c.url, n.href = n.href, c.crossDomain = k.protocol + "//" + k.host != n.protocol + "//" + n.host), c.url || (c.url = window.location.toString()), (i = c.url.indexOf("#")) > -1 && (c.url = c.url.slice(0, i)), p(c);
				var m = c.dataType,
					y = /\?.+=\?/.test(c.url);
				if (y && (m = "jsonp"), c.cache !== !1 && (e && e.cache === !0 || "script" != m && "jsonp" != m) || (c.url = h(c.url, "_=" + Date.now())), "jsonp" == m) return y || (c.url = h(c.url, c.jsonp ? c.jsonp + "=?" : c.jsonp === !1 ? "" : "callback=?")), t.ajaxJSONP(c, d);
				var w, b = c.accepts[m],
					E = {},
					T = function(t, e) {
						E[t.toLowerCase()] = [t, e]
				...
				if (d && d.promise(j), c.crossDomain || T("X-Requested-With", "XMLHttpRequest"), T("Accept", b || "*/*"), (b = c.mimeType || b) && (b.indexOf(",") > -1 && (b = b.split(",", 2)[0]), j.overrideMimeType && j.overrideMimeType(b)), (c.contentType || c.contentType !== !1 && c.data && "GET" != c.type.toUpperCase()) && T("Content-Type", c.contentType || "application/x-www-form-urlencoded"), c.headers) for (g in c.headers) T(g, c.headers[g]);
				if (j.setRequestHeader = T, j.onreadystatechange = function() {
					if (4 == j.readyState) {
						j.onreadystatechange = l, clearTimeout(w);
						var e, n = !1;
						if (j.status >= 200 && j.status < 300 || 304 == j.status || 0 == j.status && "file:" == S) {
							if (m = m || f(c.mimeType || j.getResponseHeader("content-type")), "arraybuffer" == j.responseType || "blob" == j.responseType) e = j.response;
							else {
								e = j.responseText;
								try {
									e = u(e, m, c), "script" == m ? (0, eval)(e) : "xml" == m ? e = j.responseXML : "json" == m && (e = C.test(e) ? null : t.parseJSON(e))
								} catch (t) {
									n = t
								}
								if (n) return s(n, "parsererror", j, c, d)
							}
							a(e, j, c, d)
						} else s(j.statusText || null, j.status ? "error" : "abort", j, c, d)
					}
				}, o(j, c) === !1) return j.abort(), s(null, "abort", j, c, d), j;
				var P = !("async" in c) || c.async;
				if (j.open(c.type, c.url, P, c.username, c.password), c.xhrFields) for (g in c.xhrFields) j[g] = c.xhrFields[g];
				for (g in E) N.apply(j, E[g]);
				return c.timeout > 0 && (w = setTimeout(function() {
					j.onreadystatechange = l, j.abort(), s(null, "timeout", j, c, d)
				}, c.timeout)), j.send(c.data ? c.data : null), j
			}, t.get = function() {
			...
			t(document).ready(function() {
				...
				"MSGesture" in window && (f = new MSGesture, f.target = document.body), t(document).bind("MSGestureEnd", function(t) {
					...
					(g = a(e, "down")) && !o(e) || (v = g ? e : e.touches[0], e.touches && 1 === e.touches.length && h.x2 && (h.x2 = void 0, h.y2 = void 0), d = Date.now(), m = d - (h.last || d), h.el = t("tagName" in v.target ? v.target : v.target.parentNode), s && clearTimeout(s), h.x1 = v.pageX, h.y1 = v.pageY, m > 0 && m <= 250 && (h.isDoubleTap = !0), h.last = d, l = setTimeout(n, p), f && g && f.addPointer(e.pointerId))
				}).on("touchmove MSPointerMove pointermove", function(t) {
					(g = a(t, "move")) && !o(t) || (v = g ? t : t.touches[0], r(), h.x2 = v.pageX, h.y2 = v.pageY, y += Math.abs(h.x1 - h.x2), x += Math.abs(h.y1 - h.y2))
				}).on("touchend MSPointerUp pointerup", function(n) {
					(g = a(n, "up")) && !o(n) || (r(), h.x2 && Math.abs(h.x1 - h.x2) > 30 || h.y2 && Math.abs(h.y1 - h.y2) > 30 ? u = setTimeout(function() {
						h.el && (h.el.trigger("swipe"), h.el.trigger("swipe" + e(h.x1, h.x2, h.y1, h.y2))), h = {}
					}, 0) : "last" in h && (y < 30 && x < 30 ? c = setTimeout(function() {
						var e = t.Event("tap");
	...
	129: function(t, e, n) {
		(function(t) {
			...
			var r = n(131),
				...
				s = location.href.indexOf("docs") > -1,
				c = function() {
					var t = o.clientWidth > 750 ? 750 : o.clientWidth;
					t && (o.style.fontSize = 23.4376 * (t / 750) + "px")
				};
			document.addEventListener("DOMContentLoaded", c, !1), !s && window.addEventListener(a, c, !1), document.body.addEventListener("touchstart", function() {}), t(function() {
				(0, i.
			default)(".toggle-btn")
			})
		}).call(e, n(2))
	...
	default = function(t) {
			...
			var r = document.querySelector(t),
				...
				o = i.children[0],
				a = document.querySelector("#nav-cls");
			r.addEventListener("click", n, !1), o.addEventListener("click", e, !1), a.addEventListener("click", e, !1)
		};
		var i = n(3),
			o = (r(i), n(9)),
			a = r(o);
	...
	default.attach(document.body);
		var s = document.createElement("div"),
			c = '\n                    <h2 style="padding-top: 10px;padding-left: 50px;"><img style="width:90px" src="images/wap-logo.png"/></h2>\n                    <span id="nav-cls"></span>\n                    <ul>\n                        <li><a href="/mobile">首页</a></li>\n                        <li><a href="/login">登陆</a></li>\n                        <li><a href="/register">注册</a></li>\n                        <li><a href="/demo/Mobile.php">在线体验</a></li>\n            </ul>\n                ',
			u = document.querySelector("body");
		s.setAttribute("id", "nav"), s.innerHTML = c, u.appendChild(s)
	},
	132: function(t, e, n) {
		(function(t) {
			"use strict";
			var e = t("body"),
				...
				r = function(e) {
					t(".qr_code").addClass("code_active"), n(!1), e.preventDefault()
				},
				i = function() {
					t(".qr_code").removeClass("code_active"), n(!0)
				};
			t("body").on("touchend", ".wx", r), t("body").on("touchend", ".qr_code", i), n(!0)
		}).call(e, n(2))
	},
	164: function(t, e) {}
});