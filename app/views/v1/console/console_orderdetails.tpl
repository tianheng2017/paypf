...
<body>
                            ...
                            <div class="col s12 center-align pagecontenttitle">
                                <ul class="collection">
									...
									<div class="input-field col s10">
										<input class="selkeyword" id="selkeyword" name="selkeyword" value="<{$selusername}>" placeholder="请输入订单号" type="text">
                                ...
                                <table class="striped">
                                    ...
                                    <tr class="usertr<{$datai['id']}>">
										...
										<td style="font-size:10px;white-space: nowrap;line-height: 1.4em;" class="">
											<span class="dif_span">oid：</span>
											<span class="dif_span2"><{$datai['orderid']}></span>
										</td>
										...
										<td class="tdtcenter">
											...
											<a style="font-size:10px;" href="/<{INSTALL_DIR}>/index.php/console/orderdetailsinfo/id/<{$datai['id']}>" target="_blank" class="btn">查看详情</a>
    ...
    <script type="text/javascript">
		...
		function rrcallnvM(val) {
            var options = {
                url: '/<{INSTALL_DIR}>/index.php/console/servicenotifytousereddo',
                type: 'post',
                dataType: 'text',
                data: 'id='+val,
